...
<html>
  ...
  <body>
    <div class="card">
      <div class="card-body">
        <h1>Add a Movie</h1>
        <p><a href='index.php'>Movies I Like</a></p>
        <hr/>
          <?php
                      ...
                      $_POST['movie_running_time_in_minutes']))
            {
              ...
              $query = "INSERT INTO movieListing (title, rating, director, running_time_in_minutes, genre) " .
                  "VALUES ('$movie_title', '$movie_rating', '$movie_director', '$movie_runtime', '$movie_genre_text')";
        ...
        <form class="needs-validation" novalidate method="POST" action="<?= $_SERVER['PHP_SELF']; ?>">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="movie_title" name="movie_title" placeholder="Title" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="movie_director" name="movie_director" placeholder="Director" required>
              <div class="invalid-feedback">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="number" class="form-control" id="movie_running_time_in_minutes" name="movie_running_time_in_minutes" placeholder="Running time (in minutes)" required>
              <div class="invalid-feedback">
