    ...
    <div class="card">
      <div class="card-body ">
        ...
        <form method="POST" action="<?= $_SERVER['PHP_SELF']; ?>">
          <div class="form-group">
            ...
            <input type="test" class="form-control" name="search" value= '<?=$search_term?>' placeholder="Enter some stuff">
          </div>
          ...
          if (isset($_POST['submit']))
          {
              ...
              */
              ...
              $result = mysqli_query($dbc, $query)
                      or trigger_error('Error querying database Products', E_USER_ERROR);
              */
      ...
      <div class="card-body">
        <div class="alert alert-success">
          <h2>Stuff you might be interested in...</h2>
          <br/>
