...
<div class="card">
    <div class="card-body">
       ...
       if (isset($_POST['delete_movie_submission']) && isset($_POST['id'])):
          ...
          $query =
             "SELECT image_file FROM movieListing WHERE id = $id";
       ...
       elseif (isset($_GET['id_to_delete'])):
          ...
          if (mysqli_num_rows($result) == 1) {
             ...
             if (empty($movie_image_file)) {
                $movie_image_file =
                   ML_UPLOAD_PATH . ML_DEFAULT_MOVIE_FILE_NAME;
             }
              ...
              <div class="row">
                  ...
                  <div class="col">
                      <table class="table table-striped">
                          ...
                          <tr>
                              <th scope="row">Running Time (minutes)
                              </th>
       ...
       else: // Unintended page link. No movie to remove, redirect to index
