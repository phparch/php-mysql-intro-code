    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php
            ...
            $query = "SELECT id, title, image_file, number_of_copies, number_reserved FROM movieListing ORDER BY title";
        ...
        <?php
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                if (isset($_SESSION['user_access_privileges']))
                {
                    ...
                    {
                        $movie_title_row .= "<td class='align-middle'><a class='nav-link' href='removemovie.php?id_to_delete=" .
                    ...
                    {
                        $movie_title_row .= "<td class='align-middle'><a class='nav-link' href='reservemovie.php?id_to_reserve=" .
