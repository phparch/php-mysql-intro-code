      ...
      <div class="card-body">
        ...
        <hr/>
          <?php
            ...
            elseif (isset($_POST['edit_movie_submission'], $_POST['movie_title'],
                    ...
                    $_POST['movie_image_file'], $_POST['movie_copies_number']))
            {
                ...
                $number_of_copies = (int)$_POST['movie_copies_number'];
                ...
                */
                ...
                if (empty($file_error_message))
                {
                   ...
                   $query = "UPDATE movieListing SET title = ?, rating = ?, director = ?, running_time_in_minutes = ?, " . 
                            "genre = ?, image_file = ?, number_of_copies= ? WHERE id = ?";

                    parameterizedQuery($dbc, $query, 'ssssssii', $movie_title, $movie_rating, $movie_director, $movie_runtime,
                            $movie_genre_text, $movie_image_file, $number_of_copies, $id_to_update);

                    if(mysqli_errno($dbc))
                    {
                        trigger_error('Error querying database movieListing: Failed to update movie listing', E_USER_ERROR);
                    }
        ...
        <div class="row">
          ...
          ?>
              ...
              <div class="form-group row">
                <label for="movie_copies_number=" class="col-sm-3 col-form-label-lg">Number of Copies</label>
                <div class="col-sm-8">
                  <input type="number" class="form-control" id="movie_copies_number" name="movie_copies_number" min="0" max="10" value= '<?=$number_of_copies?>'>
                </div>
              </div>          
