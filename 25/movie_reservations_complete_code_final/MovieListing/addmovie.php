      ...
      <div class="card-body">
                    ...
                    $_POST['movie_copies_number']))
            {
                ...
                */
                ...
                if (empty($file_error_message))
                {
                    ...
                    $results = parameterizedQuery($dbc, $query, 'ssssssi', $movie_title, $movie_rating, $movie_director,
                            $movie_runtime, $movie_genre_text, $movie_image_file_path, $number_of_copies);
                    
                    if(mysqli_errno($dbc))
                    {
                        trigger_error('Error querying database movieListing');
                    }
        ...
        <form enctype="multipart/form-data" class="needs-validation" novalidate method="POST" action="<?= $_SERVER['PHP_SELF']; ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="number" class="form-control" id="movie_copies_number" name="movie_copies_number" min="0" max="10" value="1">
            </div>
          </div>          
